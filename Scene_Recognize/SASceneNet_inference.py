...
completePath = './output/kfold_noen_val_sd_mitindoor/4/model_epoch_97_case_4_test.pth'
...
#test_dataset = MITIndoor67Dataset(datadir, r"test/crawl")
test_dataset = CustomDataset(datadir, "1/test")
